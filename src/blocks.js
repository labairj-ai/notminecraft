...
export const BLOCK_DEFS = [
  ...
  { name:'Glass',         solid:true,  action:'break', breakTime:0.3,  requiresTool:false, handMult:1.0,  transparent:true, textures:{ all:[12,0] },          color:'#9dcfe8' },
  { name:'Snow Block',    solid:true,  action:'dig',   breakTime:0.3,  requiresTool:false, handMult:1.5,  textures:{ top:[13,0], side:[13,0], bottom:[2,0]}, color:'#eef' },
